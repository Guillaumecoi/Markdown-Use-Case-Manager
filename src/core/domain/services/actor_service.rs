    ...
    pub fn get_actor_statistics(scenarios: &[Scenario]) -> HashMap<Actor, ActorStats> {
        ...
        for scenario in scenarios {
            for step in &scenario.steps {
                let actor_stats = stats.entry(step.actor.clone()).or_insert_with(|| ActorStats {
...
mod tests {
    ...
    fn test_extract_actors_from_use_case() {
        ...
        scenario1.add_step(ScenarioStep::new(1, Actor::User, "clicks".to_string(), "button".to_string()));
        scenario1.add_step(ScenarioStep::new(2, Actor::System, "responds".to_string(), "success".to_string()));
        
        let mut scenario2 = create_test_scenario("UC-TEST-001-S02", "Scenario 2");
        scenario2.add_step(ScenarioStep::new(1, Actor::User, "navigates".to_string(), "page".to_string()));
        scenario2.add_step(ScenarioStep::new(2, Actor::Database, "queries".to_string(), "data".to_string()));
    ...
    fn test_get_actor_statistics() {
        let mut scenario1 = create_test_scenario("UC-TEST-001-S01", "Scenario 1");
        scenario1.add_step(ScenarioStep::new(1, Actor::User, "clicks".to_string(), "button".to_string()));
        scenario1.add_step(ScenarioStep::new(2, Actor::User, "types".to_string(), "text".to_string()));
        scenario1.add_step(ScenarioStep::new(3, Actor::System, "responds".to_string(), "success".to_string()));
    ...
    fn test_suggest_primary_actor() {
        ...
        let mut scenario2 = create_test_scenario("UC-TEST-001-S02", "Scenario 2");
        scenario2.add_step(ScenarioStep::new(1, Actor::User, "navigates".to_string(), "page".to_string()));
        scenario2.add_step(ScenarioStep::new(2, Actor::System, "loads".to_string(), "data".to_string()));
    ...
    fn test_actor_participates_in_scenario() {
        let mut scenario = create_test_scenario("UC-TEST-001-S01", "Test");
        scenario.add_step(ScenarioStep::new(1, Actor::User, "clicks".to_string(), "button".to_string()));
        scenario.add_step(ScenarioStep::new(2, Actor::System, "responds".to_string(), "success".to_string()));
        
        assert!(ActorService::actor_participates_in_scenario(&Actor::User, &scenario));
        assert!(ActorService::actor_participates_in_scenario(&Actor::System, &scenario));
        assert!(!ActorService::actor_participates_in_scenario(&Actor::Database, &scenario));
    }
    ...
    fn test_get_scenarios_for_actor() {
        ...
        let mut scenario2 = create_test_scenario("UC-TEST-001-S02", "Scenario 2");
        scenario2.add_step(ScenarioStep::new(1, Actor::System, "processes".to_string(), "request".to_string()));
        
        let mut scenario3 = create_test_scenario("UC-TEST-001-S03", "Scenario 3");
        scenario3.add_step(ScenarioStep::new(1, Actor::User, "navigates".to_string(), "page".to_string()));
