...
fn test_config_default() {
    ...
    assert_eq!(config.project.description, "A project managed with use case manager");
...
fn test_project_config() {
    ...
    assert_eq!(project_config.description, "A test project for unit testing");
}
...
fn test_directory_config() {
    ...
    assert_eq!(dir_config.template_dir, Some("custom/templates".to_string()));
}
...
fn test_config_serialization() {
    ...
    assert_eq!(config.directories.use_case_dir, deserialized.directories.use_case_dir);
    assert_eq!(config.generation.test_language, deserialized.generation.test_language);
...
fn test_config_clone() {
    ...
    assert_eq!(config.directories.use_case_dir, cloned.directories.use_case_dir);
    assert_eq!(config.directories.test_dir, cloned.directories.test_dir);
    assert_eq!(config.generation.test_language, cloned.generation.test_language);
...
fn test_config_custom_values() {
    ...
    assert_eq!(config.directories.template_dir, Some("src/templates".to_string()));
    assert_eq!(config.templates.use_case_template, Some("my_template.hbs".to_string()));
...
fn test_config_field_access() {
    ...
    assert!(config.metadata.custom_fields.contains(&"new_field".to_string()));
}